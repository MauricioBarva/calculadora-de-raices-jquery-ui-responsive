...
window.addEventListener("load", function () {
  $(document).ready(function () {
    ...
    var xl_fp = parseFloat(numeroXL_fp); //Crear la función bisección que contiene las operaciones
    ...
    function falsaPosicion() {
      ...
      function formula(xl_fp) {
        ...
        var recorrer_fp = math.parse(ecuacion_fp); // Reuname la ecuacion

        var compilado_fp = recorrer_fp.compile(); //Luego creo un JSON donde la x vale xl
