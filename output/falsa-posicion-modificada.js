...
window.addEventListener("load", function () {
  $(document).ready(function () {
    ...
    var xl_m = parseFloat(numeroXL_fp_m); //Crear la función bisección que contiene las operaciones
    ...
    function falsaPosicionModificada() {
      ...
      function formula(xl_fp_m) {
        ...
        var recorrer_fp_m = math.parse(ecuacion_fp_m); // Reuname la ecuacion

        var compilado_fp_m = recorrer_fp_m.compile(); //Luego creo un JSON donde la x vale xl
