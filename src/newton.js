...
$(document).ready(function() {
    ...
    function newtonRhapson() {
        ...
        function derivadaDeLaFuncion(numero) {
            //Le digo, recorrame la ecuacion
            const recorrer_nw = math.parse(ecuacion_nw);
            derivada.value = math.derivative(recorrer_nw, 'x').toString();
        ...
        while (ea > es && contador < 1000) {
            ...
            iteracion_nw.value = contador;
            errorAproximado_nw.value = ea;
            raizAproximada_nw.value = xi;
            valorReemplazando_nw.value = funcion(xi);
        }
